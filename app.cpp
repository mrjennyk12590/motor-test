...
void main_task(intptr_t unused)
{
    ...
    monitor->display("start motor-test");
    ...
    */
    ...
    //     leftMotor->setPWM(10);
    //     sprintf(buf,"leftMotor is %-d",(int32_t )leftMotor->getCount());
    //     monitor->display(buf);
    //     if(leftMotor->getCount() >= 360)
    //     {
    //         leftMotor->stop();
    //         break;
    //     }
    ...
    //     if (ev3_button_is_pressed(BACK_BUTTON)) break;
    //     leftMotor->setPWM(10);
    //     sprintf(buf,"leftMotor1 is %-d",(int32_t)leftMotor->getCount());
    //     monitor->display(buf);
    // }
    //
    // int32_t leftOffset = leftMotor->getCount();
    // leftMotor->reset();
    //
    // while((leftOffset*-1) <= leftMotor->getCount())
    // {
    //     if (ev3_button_is_pressed(BACK_BUTTON)) break;
    //     leftMotor->setPWM(-10);
    //     sprintf(buf,"leftMotor2 is %-d",(int32_t)leftMotor->getCount());
    //     monitor->display(buf);
    // }
    ...
    // 前進
    clock->reset();
    while((360 * 3) >= leftMotor->getCount())
    {
    ...
    monitor->display("end motor-test");
    delete monitor;
